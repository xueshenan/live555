...
public:
    ...
    void decrementReferenceCount() {
        if (fReferenceCount > 0) --fReferenceCount;
    }
...
protected:
    ServerMediaSession(UsageEnvironment &env, char const *streamName, char const *info,
...
public:
    ...
    virtual void seekStream(unsigned clientSessionId, void *streamToken, char *&absStart,
                            char *&absEnd);
    ...
    virtual void getRTPSinkandRTCP(void *streamToken, RTPSink const *&rtpSink,
                                   RTCPInstance const *&rtcp) = 0;
