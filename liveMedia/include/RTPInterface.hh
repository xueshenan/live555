...
public:
    ...
    Boolean handleRead(unsigned char *buffer, unsigned bufferMaxSize,
                       // out parameters:
                       unsigned &bytesRead, struct sockaddr_storage &fromAddress, int &tcpSocketNum,
...
private:
    ...
    Boolean sendRTPorRTCPPacketOverTCP(unsigned char *packet, unsigned packetSize, int socketNum,
                                       unsigned char streamChannelId);
    Boolean sendDataOverTCP(int socketNum, u_int8_t const *data, unsigned dataSize,
